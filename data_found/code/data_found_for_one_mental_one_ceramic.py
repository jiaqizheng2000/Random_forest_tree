...
def data_found(MENTAL,CERAMIC):
    ...
    mental_ceramics_data=pd.concat([metal_matminer.drop(columns=['Me_comp']),sys_cond_0.drop(columns=['Metal','Sub_comp']),feature_all],axis=1)
    return mental_ceramics_data
